		      	...
		      	<div class="row">
		       		<div class="col-xs-12 col-sm-12 text-center" style="background-color: #272727;">
						...
						<div class="col-md-12">
							...
							<c:forEach items="${diveSearches}" var="item">
								<tr>
									<td class="indent">
											<a style="color:#fff;" class="searchlink" href="http://ec2-52-28-200-8.eu-central-1.compute.amazonaws.com/dive/web/app_dev.php?q=${item}">
											${item}</a>
