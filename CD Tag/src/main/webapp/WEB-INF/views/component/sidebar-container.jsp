...
<div id="sidebar-wrapper"style="overflow-y: auto;">
    <ul class="sidebar-nav">
        ...
        <li class="change-item" data-item="homepage" id="homepage">
		...
		<c:choose>
			...
			<c:when test="${user == null || user.anonymous}">
				...
				<table>
		            <tr>
		                <td width="15px">&nbsp;</td>
		                <td class="statfont" width="120px" height="120px" style="background-color:#5cbbf2;"><a href="javascript:;"><span class="change-item" data-item="gamesplayed">GAMES PLAYED</span><br></a><span class="bignumber spincrement"><nf:format number="${globalStats.totalMatches}" /></span></td>
		                <td width="30px">&nbsp;</td>
			...
			<c:otherwise>
				...
				<table>
		            ...
		            <tr>
		                <td width="15px">&nbsp;</td>
		                <td class="statfont" width="120px" height="120px" style="background-color:#e64c65;"><span class="change-item" data-item="curatedtags">CURATED<br>TAGS<br></span>
		                	<span class="bignumber spincrement">
		                		<fmt:formatNumber type="number" value="${globalStats.totalDiveCurated}" maxFractionDigits="0" pattern="###.###" />
		                	 </span>
