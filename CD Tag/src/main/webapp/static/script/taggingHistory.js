		...
		tags.forEach(function(tag){
			...
			if (!el.length) {
				...
				if (tag.dictionary) {
				    ...
				    } else if (tag.dictionary == "real-location") {
                        	iconSrc = '/static/img/real-place.png';
                        	el.append(jQuery('<img/>',  { 'class' : 'icon', 'title' : 'This tag was found in the ' + tag.dictionary + ' dictionary', 'src' : iconSrc }));
                    } else if (tag.dictionary == "fictional-location") {
                        	iconSrc = '/static/img/fictional-place.png';
                        	el.append(jQuery('<img/>',  { 'class' : 'icon', 'title' : 'This tag was found in the ' + tag.dictionary + ' dictionary', 'src' : iconSrc }));
                    } else if (tag.dictionary == "events") {
                        	iconSrc = '/static/img/event.png';
                        	el.append(jQuery('<img/>',  { 'class' : 'icon', 'title' : 'This tag was found in the ' + tag.dictionary + ' dictionary', 'src' : iconSrc }));
                    } else if (tag.dictionary == "fictional-person") {
                        	iconSrc = '/static/img/fictional-person.png';
                        	el.append(jQuery('<img/>',  { 'class' : 'icon', 'title' : 'This tag was found in the ' + tag.dictionary + ' dictionary', 'src' : iconSrc }));
                    } else if (tag.dictionary == "real-person") {
                        	iconSrc = '/static/img/real-person.png';
                        	el.append(jQuery('<img/>',  { 'class' : 'icon', 'title' : 'This tag was found in the ' + tag.dictionary + ' dictionary', 'src' : iconSrc }));
                    } else {
