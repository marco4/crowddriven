...
@Controller
public class DiveCampaignController {
	...
	@RequestMapping(value = { "/dive-campaign.html" })
	public String home(@RequestParam(defaultValue = "1", required = false) int page, ModelMap model, HttpSession session) {
		...
		return "z_dive-campaign";
	}

	@RequestMapping(value = { "tagcampaign" })
	public String getHomepageContainer(ModelMap model, HttpSession session) {
		
		return "component/tagcampaign-container";
	}
